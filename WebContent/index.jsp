        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        <!-- ***** Logo Start ***** -->
                        <a href="index.html" class="logo">AJ<em> Studio</em></a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                    ...
                    <ul class="features-items">
                        ...
                        <li class="feature-item">
                            ...
                            <div class="right-content">
                                ...
                                <p>If you wish to support NxtNova website via PayPal, please feel free to contact us. We appreciate it a lot.</p>
                                <a href="#" class="text-button">Discover More</a>
                            </div>
                        </li>
                        <li class="feature-item">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="contact-form">
                        <form id="contact" action="enquiry" method="post">
                          <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    - Designed by <a rel="nofollow" href="https://github.com/sammy171207" class="tm-text-link" target="_parent">Sammy</a><br>

                Distributed by <a rel="nofollow" href="" class="tm-text-link" target="_blank">NxtNova</a>
